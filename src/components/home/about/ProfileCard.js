...
const ProfileCard = () => (
  <div className="profile-card">
    <img className="profile-card__img" src={profilePic} alt="Armaiz Adenwala" />
    <h4 className="tg__title-6 profile-card__title">Armaiz Adenwala</h4>
    <p className="tg__body-1 profile-card__location">Sacramento, CA</p>
    <p className="tg__body-1 profile-card__email">armaiz.adenwala@gmail.com</p>
    <div className="profile-card__social">
      <a className="profile-card__social__link" href="https://www.google.com/">
